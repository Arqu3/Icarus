...
public static class Math3d
{
	...
	/// </summary>
	/// <param name="childPosition">Input: parentRotation and parentPosition: the current parent transform.</param>
	///
	...
	{
		childRotation = parentRotation * Quaternion.Inverse(startParentRotation) * startChildRotation;
		childPosition = parentPosition + parentRotation * Quaternion.Inverse(startParentRotation) * (startChildPosition- startParentPosition);
	}

	/// <summary>
	/// Transform the object as though it was parented to the other
	/// </summary>
	/// <param name="child"></param>
	/// <param name="parent"></param>
	/// <param name="startParentRotation"></param>
	/// <param name="startParentPosition"></param>
	public static void TransformWithParent(this Transform child, Transform parent, Quaternion startParentRotation, Vector3 startParentPosition)
	{
		Quaternion r;
		Vector3 p;
		TransformWithParent(out r, out p, parent.rotation, parent.position, startParentRotation, startParentPosition, child.rotation, child.position);
		child.rotation = r;
		child.position = p;
	}
